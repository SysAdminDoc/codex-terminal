...
[![Version](https://img.shields.io/badge/version-0.11.0-cba6f7?style=flat-square)](CHANGELOG.md)
...
```powershell
codium --install-extension codex-terminal-0.11.0.vsix   # VSCodium
code   --install-extension codex-terminal-0.11.0.vsix   # VS Code
```
...
npm run package   # -> dist/codex-terminal-0.11.0.vsix
```
...
npm ci
npm run package
Get-FileHash -Algorithm SHA256 dist\codex-terminal-0.11.0.vsix
```
